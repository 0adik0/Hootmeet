package com.decadescript.hotmeet
...
import com.decadescript.hotmeet.activities.SignInActivity
...
class SplashActivity : AppCompatActivity() {
    ...
    private fun callServer() {
        ...
        val httpAsync = "https://trk.hotmeetapp.xyz/WcCLdWMY?x=1"
            .httpGet()
            .timeout(20000)
    ...
    private fun initAppsFlyer() {
        ...
        AppsFlyerLib.getInstance().init("uuf7igoxQ2GdP78i7RKkQX", conversionDataListener, this)
        AppsFlyerLib.getInstance().startTracking(applicationContext as Application)
        AppsFlyerLib.getInstance().setDebugLog(true)
    }

    private fun secondCall() {
        val httpAsync = "https://trk.hotmeetapp.xyz/WcCLdWMY?y=1"
            .httpGet()
            .timeout(20000)
            .header("Content-Type", "application/json; utf-8")
            .responseString { _, _, result ->
    ...
    private fun getFBDeep() {
        AppLinkData.fetchDeferredAppLinkData(this) {
            if (it != null) {
                ...
                setDepL("&${getIt.substringAfter("htmt://")}")
    ...
    private fun getFirst() =
        PreferenceManager.getDefaultSharedPreferences(this).getBoolean("first", false)

    private fun setFirst(value: Boolean) {
        val editor = PreferenceManager.getDefaultSharedPreferences(this).edit()
